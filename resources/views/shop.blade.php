@extends('layouts.app')
@section('content')
    <<<<<<< HEAD <div class="position-relative d-flex justify-content-center align-items-center"
        style="height: 185px; ;background-image: url('images/banner/banner_ShopWeb.webp')">
        <h2 class="text-center text-white ">Hệ thống 154 cửa hàng The Coffee House trên
            =======
            <div class="position-relative">
                <img class="w-100" src="{{ asset('images/banner/banner_Shop.webp') }}" alt="">
                <h2 class="position-absolute top-50 start-50 translate-middle text-white">Hệ thống 154 cửa hàng The Coffee
                    House trên
                    >>>>>>> d11033def65a72ac200561b764b2d179c1e80248
                    toàn quốc</h2>
            </div>
            <div class="container">
                <div class="row">
                    <<<<<<< HEAD <div class="col-2 border-right">
                        =======
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="card w-100">
                                                <img src="{{ asset('images/footer/thecoffeehouse.jpg') }}"
                                                    class="card-img-top" alt="...">
                                                <div class="card-body">
                                                    <h5 class="card-title">HCM SIGNATURE by The Coffee House</h5>
                                                    <a href="#" class="btn w-100 text-danger"
                                                        style="background: #f7fbd1">Xem bản
                                                        đồ</a>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <p class="mb-0 me-2"><strong>Chia sẻ trên:</strong></p>
                                                        <a href="" class="d-inline-block mx-2">
                                                            <img style="max-width: 25px"
                                                                src="{{ asset('images/icon/icon_facebook.svg') }}"
                                                                alt="Facebook">
                                                        </a>
                                                        <a href="" class="d-inline-block mx-2">
                                                            <img style="max-width: 25px"
                                                                src="{{ asset('images/icon/icon_zalo.svg') }}"
                                                                alt="Zalo">
                                                        </a>
                                                        <a href="" class="d-inline-block mx-2">
                                                            <img style="max-width: 25px"
                                                                src="{{ asset('images/icon/icon_link.svg') }}"
                                                                alt="Link">
                                                        </a>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <p>7:00 - 22:00</p>
                                                    <<<<<<< HEAD <div class="row w-max">
                                                        <div class="col-md-6 d-inline-block">
                                                            <img class="d-inline-block" style="max-width: 20px;"
                                                                src="{{ asset('images/icon/icon_car.png') }}"
                                                                alt="">
                                                            <p class="d-inline-block">Có chỗ đỗ xe hơi</p>
                                                        </div>
                                                        <div class="col-md-6 d-inline-block">
                                                            <img class="d-inline-block" style="max-width: 20px;"
                                                                src="{{ asset('images/icon/icon_shop.png') }}"
                                                                alt="">
                                        ...
                                        <div class="card w-100">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn w-100 text-danger"
                                                    style="background: #f7fbd1">Xem bản
                                                    đồ</a>
                                                <<<<<<< HEAD <div class="d-flex align-items-center mt-3">
                                                    <p class="mb-0 me-2"><strong>Chia sẻ trên:</strong></p>
                                                    <a href="" class="d-inline-block mx-2">
                                                        <img style="max-width: 25px"
                                                            src="{{ asset('images/icon/icon_facebook.svg') }}"
                                                    ...
                                                    <a href="" class="d-inline-block mx-2">
                                                        <img style="max-width: 25px"
                                                            src="{{ asset('images/icon/icon_zalo.svg') }}" alt="Zalo">
                                                    </a>
                                                    <a href="" class="d-inline-block mx-2">
                                                        <img style="max-width: 25px"
                                                            src="{{ asset('images/icon/icon_link.svg') }}" alt="Link">
                                                    </a>
                                            </div>
                                            <hr>
        ...
        <<<<<<< HEAD @endsection=======>>>>>>> d11033def65a72ac200561b764b2d179c1e80248
