                        ...
                        <li class="menu">
                            ...
                            <ul class="list_1">
                                ...
                                <li>
                                    <a href="#">CloudFee</a>
                                    <ul class="mini-menu">
                                        <li><a href="#">CloudFee</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">CloudTea</a>
                                    <ul class="mini-menu">
                                        <li><a href="#">CloudTea</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">Trà</a>
                                ...
                                <li>
                                    ...
                                    <ul class="mini-menu">
                                        ...
                                        <li><a href="#">Hi-Tea Đá Tuyết</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">Bánh & Snack</a>
                                    <ul class="mini-menu">
                                        ...
                                        <li><a href="#">Đá Tuyết</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">Tại nhà</a>
                                    <ul class="mini-menu">
                                        <li><a href="#">Cà phê tại nhà</a></li>
                                        <li><a href="#">Trà tại nhà</a></li>
                                    </ul>
                                </li>
                                <li>
