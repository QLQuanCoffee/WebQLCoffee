...
Route::prefix('admin')->name('admin.')->group(function(){
    Route::prefix('order')->name('order.')->group(function(){
        ...
        Route::pet('/delete/{id}',[OrderController::class,'delete'])->name('delete');
    });
    ...
    Route::prefix('product')->name('product.')->group(function(){
        ...
        Route::pet('/delete/{id}',[ProductController::class,'delete'])->name('delete');
    });
    ...
    Route::prefix('shop')->name('shop.')->group(function(){
        ...
        Route::pet('/delete/{id}',[ShopController::class,'delete'])->name('delete');
    });
    ...
    //     Route::pet('/delete/{id}',[ToppingController::class,'delete'])->name('delete');
    // });
});
